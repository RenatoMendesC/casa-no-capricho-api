...
const CATEGORIAS = [
  ...
  { categoria: "Cozinha", termos: ["potes hermeticos cozinha", "porta temperos cozinha", "escorredor louca", "cortador legumes", "utensilios cozinha", "organizador cozinha", "escorredor talheres", "porta mantimentos", "tábua cozinha", "porta utensilios cozinha", "kit potes cozinha", "dispenser cereais", "colher de pau", "colher madeira cozinha", "talheres silicone", "kit utensilios silicone", "jogo de panelas", "panela antiaderente", "panela pressao", "panela de pressao", "panela pressao eletrica", "porta pratos", "escorredor pratos", "passa pratos"] },
